...
2. Change path to the script directory (`sourceDir`) in `fix-ini.js`.
3. Change path to the game directory (`targetDir`) in `fix-ini.js` (required only once per game installation).
